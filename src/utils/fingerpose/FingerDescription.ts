type FingerType = {
  ...
  pointsMapping: { [key: number]: number[][] };
  getName: (value: number) => string | boolean;
  getPoints: (value: number) => number[][] | boolean;
};
...
const FingerCurl: FingerCurlType = {
  NoCurl: 0,
  HalfCurl: 1,
  FullCurl: 2,
...
const FingerDirection: FingerDirectionType = {
  VerticalUp: 0,
  VerticalDown: 1,
  HorizontalLeft: 2,
  HorizontalRight: 3,
